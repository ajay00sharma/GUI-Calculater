...
class Calculator:
    ...
    def create_clear_button(self):
        button = tk.Button(self.buttons_frame, text="C", bg=OFF_BLACK, fg=WHITE, font=DEFAULT_FONT_STYLE,
    ...
    def create_square_button(self):
        button = tk.Button(self.buttons_frame, text="x\u00b2", bg=OFF_BLACK, fg=WHITE, font=DEFAULT_FONT_STYLE,
